  ...
  return (
    <div className={data.background_color ? data.background_color : "bg-sn-black-light"}>
      <div className="max-w-7xl mx-auto py-12 px-8 lg:p-24">
        ...
        {data.iframeUrl ? (
          <iframe className="w-full h-[800px] rounded-xl" src={data.iframeUrl} />
        ) : (
          <div className="text-center text-base font-medium leading-7 text-sn-yellow uppercase tracking-widest">
            Coming soon
          </div>
        )}
      </div>
