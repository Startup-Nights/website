...
export const Booth = ({ data }) => {
  ...
  const handleUpload = async (event) => {
    ...
    const url =
      "https://faas-fra1-afec6ce7.doserverless.co/api/v1/web/fn-70cb3437-eee1-474d-8ad6-387035b15671/website/upload";
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await fetch(
      "https://faas-fra1-afec6ce7.doserverless.co/api/v1/web/fn-70cb3437-eee1-474d-8ad6-387035b15671/website/mail",
      {
        method: "post",
        headers: {
          "Content-Type": "application/json",
